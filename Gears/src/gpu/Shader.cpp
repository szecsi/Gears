...
Shader::Shader(std::string vertexShaderSource, std::string geometryShaderSource, std::string fragmentShaderSource)
{
...
void Shader::linkShaders(GLuint& vertexShader, GLuint& fragmentShader, GLuint& geometryShader, GLuint& handle){
  ...
  if(geometryShader != 0)
  {
	  ...
	  glProgramParameteri(handle, GL_GEOMETRY_OUTPUT_TYPE_EXT, GL_TRIANGLE_STRIP);
  }
