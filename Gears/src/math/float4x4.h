...
public:
	...
	static float4x4 fromQuat(const float4& quat)
	{
	    float4x4 r = identity;
		
	    float s = quat.xyz.length();
	    float c = quat.w;
	    float t = 1 - c;
		float3 axis = quat.xyz;
	...
	float determinant() const
	{
		...
		invl[0] =  (_11 * d32 - _21 * d31 + _31 * d21);
		invl[1] = -(_01 * d32 + _21 * d03 + _31 * d20);
		invl[2] =  (_01 * d31 + _11 * d03 + _31 * d10);
		invl[3] = -(_01 * d21 - _11 * d20 + _21 * d10);
		
		det = _00 * invl[0] + _10 * invl[1] + _20 * invl[2] + _30 * invl[3];
