...
public:
	...
	unsigned int	displayHeight_px;			//< Screen size.
	unsigned int	displayWidth_px;			//< Screen size.
	...
	float getSpatialKernelWidth_um() const { return maxKernelWidth_um + fieldWidth_um; }
	float getSpatialKernelHeight_um() const { return maxKernelHeight_um + fieldHeight_um; }
