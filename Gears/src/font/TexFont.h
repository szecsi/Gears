...
class TexFont
{
	...
	struct GlyphInfo {GLYPHMETRICS gm; int charcode;};
...
public:
	...
	Gears::Math::float3 getTextExtent(std::string otext, std::string fontFace, bool italic, bool bold, unsigned int nChars = 0xefffffff);
