    ...
    def boot(
            ...
            *,
            ...
            shapeMotion     : 'Motion component for shape animation. (Motion.*)'
                            = Motion.Linear()       ,
            pattern         : 'Component for pattern. (Figure.*)'
                            = Figure.Solid()       ,
            patternMotion   : 'Motion component for pattern animation. (Motion.*)'
                            = Motion.Linear()       ,
            background      : 'Component for pattern. (Figure.*)'
        ...
        rootFigure = ((shape << warp << shapeMotion ) ** (pattern << warp << patternMotion, background << warp << backgroundMotion)) << modulation
