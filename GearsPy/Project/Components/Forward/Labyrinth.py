...
XXXXXXXXXXXXXXXX"""
        ...
        stimulus.registerCallback(gears.MouseMoveEvent.typeId, self.onMouse )
        stimulus.registerCallback(gears.MousePressedLeftEvent.typeId, self.onMouseClick )
