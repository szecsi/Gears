...
class Spot(SingleShape) :
    ...
    def boot(
            ...
            *,
            ...
            modulation      : "Intensity modulation component. (Modulation.*) If specified, parameter 'color' is ignored."
                            = None          #TODO actual default uses parameter 'color'
            ):
        ...
        super().boot(name=name, duration=duration, duration_s=duration_s,
                     ...
                     #polygonMask = [{'x':0, 'y':0, 'width':radius*2, 'height':radius*2, 'figure':0}],
                     )